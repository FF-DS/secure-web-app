          ...
          <v-list-item-content>
            <v-row row>
              <v-col cols="12" sm="5">
                <v-chip
                  label
                  :color="getStatus(awardData.status).color"
                  text-color="white"
                  class="award-card-chip px-2 py-0"
                >
                  <v-icon left class="award-icons">
                    {{ getStatus(awardData.status).icon }}
                  </v-icon>
                  {{ awardData.status }}
                </v-chip>
                <v-list-item-content>
                  <v-card-title class="headline mb-1 award-card-title">
                    {{ awardData.title }}
                  </v-card-title>
                  <v-card-subtitle class="award-card-sub-title">
                ...
                <v-list>
                  <v-list-item-group>
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        <v-list-item-title class="award-card-data">
                          Publisher
                        </v-list-item-title>
                        <v-list-item-subtitle class="award-card-data">
                          {{ awardData.company_id.name }}
                    ...
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle class="award-card-data">
                          {{ awardData.tender_identification }}
                        </v-list-item-subtitle>
                      </v-list-item-content>
                    </v-list-item>
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle class="award-card-data">
                          {{ awardData.country }}</v-list-item-subtitle
                        >
                      </v-list-item-content>
                    </v-list-item>
                  </v-list-item-group>

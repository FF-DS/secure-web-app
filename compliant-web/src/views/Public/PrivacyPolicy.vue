<template>
  <v-container class="secondary--text">
    ...
    <div class="ml-5 mt-5">
      At TenderMap, accessible from https://www.TenderMap.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by TenderMap
    ...
    <div class="ml-5 mt-3">
      ...
      and/or collect in TenderMap. This policy is not applicable to any
    ...
    <h4 class="ml-5 mt-5">Information we collect</h4>
    <div class="ml-5 mt-3">
      ...
      telephone number. How we use your information
    </div>
    <div class="ml-5 mt-3">
    ...
    <div class="ml-5 mt-5">
      Log Files TenderMap follows a standard procedure of using log files. These
    ...
    <div class="ml-5 mt-5">
      Cookies and Web Beacons Like any other website, TenderMap uses 'cookies'.
      ...
      other information. For more general information on cookies, please read
      "What Are Cookies". Advertising Partners Privacy Policies You may consult
      this list to find the Privacy Policy for each of the advertising partners
      of TenderMap. Third-party ad servers or ad networks uses technologies like
      cookies, JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on TenderMap, which are sent directly
      ...
      you see on websites that you visit. Note that TenderMap has no access to
      or control over these cookies that are used by third-party advertisers.
    </div>
    <div class="ml-5 mt-5">
      Third Party Privacy Policies TenderMap's Privacy Policy does not apply to
    ...
    <div class="ml-5 mt-5">
      GDPR Data Protection Rights We would like to make sure you are fully aware
      ...
      that we complete the information you believe is incomplete. The right to
      erasure – You have the right to request that we erase your personal data,
      under certain conditions. The right to restrict processing – You have the
      right to request that we restrict the processing of your personal data,
      under certain conditions. The right to object to processing – You have the
    ...
    <div class="ml-5 mt-5  text-center">
      TenderMap does not knowingly collect any Personal Identifiable Information

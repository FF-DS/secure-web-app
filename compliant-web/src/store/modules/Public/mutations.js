exports.mutations = {
    ...
    setAmountOfDataItemValue: (state, amount) => (state.amountOfDataItem = amount),
    setCurrentTenderSearchTypeValue: (state, searchType) => (state.currentTenderSearchType = searchType),
    setCurrentSearchParams: (state, searchParam) => (state.currentSearchParams = searchParam),
    ...
    setTenderPageInfo: (state, info) => {
        ...
        state.tenderPageInfo.numberOfPages = Math.ceil(info.data_count/info.page_size);
    ...
    setAwardPageInfo: (state, info) => {
        ...
        state.awardPageInfo.numberOfPages = Math.ceil(info.data_count/info.page_size);
    ...
    setCompanyPageInfo: (state, info) => {
        ...
        state.companyPageInfo.numberOfPages = Math.ceil(info.data_count/info.page_size);
